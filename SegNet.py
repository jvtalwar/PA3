...
class SegNet(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        self.deconv1One = nn.Conv2d(64, 64, kernel_size=3, padding=1, dilation=1)
        self.finalConv = nn.Conv2d(64, n_class, kernel_size=1)
    ...
    def forward(self, x):
        ...
        x = self.relu(self.bn1(self.deconv1One(x)))
        x = self.finalConv(x)
