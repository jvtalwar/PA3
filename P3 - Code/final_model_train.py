...
from ExperiNet import *
from transfer_resnet import *

# Import dataloader and utility functions
...
best_model_name = "basic_fcn_model"

training_batch = 4
val_batch = 4
test_batch = 1
train_dataset = CityScapesDataset(csv_file='train.csv', transforms = None, resize_factor = 0.5)
